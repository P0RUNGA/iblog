		...
		<div class="main row">
			<div class="col-md-8 blog_left">
				...
				<?php $form = ActiveForm::begin([
					...
					<?= $form->field($model, 'blog_title',['labelOptions' => ['label' => '标题:','class' => 'eml']])->textInput() ?>

					<?= $form->field($model, 'blog_body',['labelOptions' => ['label' => '内容:','class' => 'eml']])->textarea(['rows'=>12]) ?>
